...
keyboard = {}
keyboard.inline_keyboard = {{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
...
--     Source Mikasa     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then PPPPD  = "المطور" elseif SecondSudo(msg) then PPPPD = "المطور" elseif SudoBot(msg) then PPPPD = "المطور" elseif ManagerAll(msg) then PPPPD = "المدير" elseif AdminAll(msg) then PPPPD = "الادمن" elseif AbsConstructor(msg) then PPPPD = "المالك" elseif BasicConstructor(msg) then PPPPD = "المنشئ" elseif Constructor(msg) then PPPPD = "المنشئ" elseif Manager(msg) then PPPPD = "المدير" elseif Admin(msg) then PPPPD = "الادمن" else PPPPD = "العضو" end return PPPPD end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1214622341) then PPPPD = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Mikasa) then PPPPD = 'البوت' elseif SudoId(user_id) then PPPPD = 'المطور الاساسي' elseif DevAbs:sismember(Mikasa..'Abs:SecondSudo:', user_id) then PPPPD = 'المطور الثانوي' elseif DevAbs:sismember(Mikasa..'Abs:SudoBot:', user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(Mikasa..'Abs:ManagerAll:', user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(Mikasa..'Abs:AdminAll:', user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(Mikasa..'Abs:VipAll:', user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(Mikasa..'Abs:AbsConstructor:'..chat_id, user_id) then PPPPD = 'المالك' elseif DevAbs:sismember(Mikasa..'Abs:BasicConstructor:'..chat_id, user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(Mikasa..'Abs:Constructor:'..chat_id, user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(Mikasa..'Abs:Managers:'..chat_id, user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(Mikasa..'Abs:Admins:'..chat_id, user_id) then PPPPD = DevAbs:get(Mikasa.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(Mikasa..'Abs:VipMem:'..chat_id, user_id) then  PPPPD = DevAbs:get(Mikasa.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(Mikasa..'Abs:Cleaner:'..chat_id, user_id) then  PPPPD = DevAbs:get(Mikasa.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else PPPPD = DevAbs:get(Mikasa.."Abs:mem:Rd"..chat_id) or 'العضو' end return PPPPD end
--     Source Mikasa     --
...
EditMsg(Chat_Id2, Msg_Id2,'꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPPD')..')\n꙳.︙تم رفعه في قائمة المميزين')
end,nil)
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPPD')..')'..' ❩\n꙳.︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'PPPPD')..')'..' ❩\n꙳.︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '꙳.︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "PPPPD")..')', 1, 'md') 
...
local PPPPD = '꙳.︙اهلا عزيزي -› '..AbsRank(msg)..' \n꙳.︙تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, PPPPD, 14, string.len(msg.sender_user_id_))
...
local PPPPD =  DevAbs:smembers(Mikasa..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..PPPPD[math.random(#PPPPD)]..']' , 1, 'md')  
end
end
--     Source Mikasa     --
...
function PPPPD(extra,result,success)
...
getUser(msg.sender_user_id_, PPPPD)
end
end
--     Source Mikasa     --
text = msg.content_.text_
...
if DevAbs:get('PPPPD:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('PPPPD:'..Mikasa..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم الغاء الامر', 1, 'md')
DevAbs:del('PPPPD:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('PPPPD:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('PPPPD:'..Mikasa..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('PPPPD:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('PPPPD:'..Mikasa..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم الغاء الامر', 1, 'md')
DevAbs:del('PPPPD:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('PPPPD:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('PPPPD:'..Mikasa..'ids:user'..msg.chat_id_)  
...
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا')
local PPPPD = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD[math.random(#PPPPD)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا') 
local PPPPD = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD[math.random(#PPPPD)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا') then 
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا')
local PPPPD = {'كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' '} 
Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD[math.random(#PPPPD)] , 1, 'html') 
return false 
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
PPPPD = '꙳.︙اول واحد يدز هذا السمايل يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
return false
end end
...
PPPPD = '꙳.︙مبروك لقد ربحت في اللعبه \n꙳.︙ارسل -› سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
...
PPPPD = '꙳.︙اول واحد يرتبها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
return false
end end
if text == DevAbs:get(Mikasa..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Mikasa..'Abs:Games:Ids'..msg.chat_id_) then
...
PPPPD = '꙳.︙اول واحد يحلها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
return false
end end
if text == DevAbs:get(Mikasa..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Mikasa..'Abs:Games:Ids'..msg.chat_id_) then
...
PPPPD = '꙳.︙ما معنى هذا السمايل :؟ -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
PPPPD = '꙳.︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md')
return false
end end
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),PPPPD)
end
end
--     Source Mikasa     --
...
Text = [[
Welcome To Source
[˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .](httpsك://t.me/PPPPD)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˛ ꪑ𝓲𝙠ꪖ𝘴𝙖 𝙩ꫀꪖ𝙢 .',url="https://t.me/PPPPD"}},
...
local PPPPD = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md') 
local PPPPD = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..PPPPD[math.random(#PPPPD)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,PPPPD)
end
end
--     Source Mikasa     --
...
local PPPPD = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md') 
local PPPPD = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..PPPPD[math.random(#PPPPD)], 1, 'md') 
end 
...
local PPPPD = "صارر ستاذيي ??🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md') 
local PPPPD = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..PPPPD[math.random(#PPPPD)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local PPPPD = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md') 
local PPPPD = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..PPPPD[math.random(#PPPPD)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local PPPPD = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,PPPPD, 1, 'md') 
local PPPPD = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..PPPPD[math.random(#PPPPD)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
local Text = '꙳.︙قم باستعمال الازرار لرفع العضو -› ⤈\n꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPPD')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
end
...
local Text = '꙳.︙قم باستعمال الازرار لتنزيل العضو -› ⤈\n꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'PPPPD')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/PPPPD"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
PPPPD = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,PPPPD[math.random(#PPPPD)])
end
--     Source Mikasa     --
...
DevAbs:set('PPPPD:'..Mikasa..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('PPPPD:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('PPPPD:'..Mikasa..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('PPPPD:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set("Mikasa:New:id:"..Mikasa..msg.sender_user_id_,'PPPPD')
return "PPPPD"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙رجائا اتبع التعليمات للتعيين \n꙳.︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه -› ⤈\n≪━━━━━ꪑ𝙠━━━━━≫\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n≪━━━━━ꪑ𝙠━━━━━≫', 1, 'md')
DevAbs:set("Mikasa:New:id:"..Mikasa..msg.chat_id_..msg.sender_user_id_,'PPPPD')
return "PPPPD"
end
...
function PPPPD(extra,abbas,success)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '᥀ Mikasa Team .',url="t.me/PPPPD"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "الروابط" then if DevAbs:get(Mikasa..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الروابط -› "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(Mikasa..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙المعرف -› "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(Mikasa..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙المتحركه -› "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(Mikasa..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الملصقات -› "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الصور" then if DevAbs:get(Mikasa..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الصور -› "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(Mikasa..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الفيديو -› "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(Mikasa..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local PPPPD = "\n" .."꙳.︙الاونلاين -› "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(Mikasa..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الدردشه -› "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(Mikasa..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local PPPPD = "\n" .."꙳.︙التوجيه -› "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(Mikasa..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الاغاني -› "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(Mikasa..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local PPPPD = "\n" .."꙳.︙الصوت -› "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(Mikasa..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الجهات -› "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(Mikasa..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local PPPPD = "\n" .."꙳.︙الماركداون -› "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(Mikasa..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local PPPPD = "\n" .."꙳.︙الهاشتاك -› "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "التعديل" then if DevAbs:get(Mikasa..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local PPPPD = "\n" .."꙳.︙التعديل -› "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(Mikasa..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local PPPPD = "\n" .."꙳.︙التثبيت -› "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(Mikasa..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الاشعارات -› "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(Mikasa..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الكلايش -› "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الدخول" then if DevAbs:get(Mikasa..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local PPPPD = "\n" .."꙳.︙الدخول -› "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(Mikasa..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الشبكات -› "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "المواقع" then if DevAbs:get(Mikasa..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙المواقع -› "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "العربيه" then if DevAbs:get(Mikasa..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙العربيه -› "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(Mikasa..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local PPPPD = "\n" .."꙳.︙الانكليزيه -› "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الكفر" then if DevAbs:get(Mikasa..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local PPPPD = "\n" .."꙳.︙الكفر -› "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الفشار" then if DevAbs:get(Mikasa..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local PPPPD = "\n" .."꙳.︙الفشار -› "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(Mikasa..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local PPPPD = "\n" .."꙳.︙الطائفيه -› "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, PPPPD, 1, 'md') end
end
--     Source Mikasa     --
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "PPPPD")..")"
else 
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help0'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help01'..msg.sender_user_id_)
if PPPPD == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help21'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help31'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help41'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help51'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local PPPPD =  DevAbs:get(Mikasa..'Abs:Help61'..msg.sender_user_id_)
if PPPPD == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙Channel ↬ [@PPPPD]', 1, 'md')    
end 
--     Source Mikasa     --
