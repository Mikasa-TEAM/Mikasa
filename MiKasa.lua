...
FilesPrint = FilesPrint.."\27[35m".."≪━━━━━ꪑ𝙠━━━━━≫ ≈ ┉ ≈ ┉\n".."\27[m"
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
...
--     Source Mikasa     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then x_Mikasa  = "المطور" elseif SecondSudo(msg) then x_Mikasa = "المطور" elseif SudoBot(msg) then x_Mikasa = "المطور" elseif ManagerAll(msg) then x_Mikasa = "المدير" elseif AdminAll(msg) then x_Mikasa = "الادمن" elseif AbsConstructor(msg) then x_Mikasa = "المالك" elseif BasicConstructor(msg) then x_Mikasa = "المنشئ" elseif Constructor(msg) then x_Mikasa = "المنشئ" elseif Manager(msg) then x_Mikasa = "المدير" elseif Admin(msg) then x_Mikasa = "الادمن" else x_Mikasa = "العضو" end return x_Mikasa end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1214622341) then x_Mikasa = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Mikasa) then x_Mikasa = 'البوت' elseif SudoId(user_id) then x_Mikasa = 'المطور الاساسي' elseif DevAbs:sismember(Mikasa..'Abs:SecondSudo:', user_id) then x_Mikasa = 'المطور الثانوي' elseif DevAbs:sismember(Mikasa..'Abs:SudoBot:', user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(Mikasa..'Abs:ManagerAll:', user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(Mikasa..'Abs:AdminAll:', user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(Mikasa..'Abs:VipAll:', user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(Mikasa..'Abs:AbsConstructor:'..chat_id, user_id) then x_Mikasa = 'المالك' elseif DevAbs:sismember(Mikasa..'Abs:BasicConstructor:'..chat_id, user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(Mikasa..'Abs:Constructor:'..chat_id, user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(Mikasa..'Abs:Managers:'..chat_id, user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(Mikasa..'Abs:Admins:'..chat_id, user_id) then x_Mikasa = DevAbs:get(Mikasa.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(Mikasa..'Abs:VipMem:'..chat_id, user_id) then  x_Mikasa = DevAbs:get(Mikasa.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(Mikasa..'Abs:Cleaner:'..chat_id, user_id) then  x_Mikasa = DevAbs:get(Mikasa.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else x_Mikasa = DevAbs:get(Mikasa.."Abs:mem:Rd"..chat_id) or 'العضو' end return x_Mikasa end
--     Source Mikasa     --
...
local UserName = (dp.username_ or "x_Mikasa")
...
EditMsg(Chat_Id2, Msg_Id2,'꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'x_Mikasa')..')\n꙳.︙تم رفعه في قائمة المميزين')
end,nil)
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevAbs:sadd(Mikasa.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevAbs:sadd(Mikasa.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevAbs:sadd(Mikasa.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevAbs:sadd(Mikasa.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAbs:sadd(Mikasa.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAbs:set(Mikasa.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'x_Mikasa')..')'..' ❩\n꙳.︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'x_Mikasa')..')'..' ❩\n꙳.︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '꙳.︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "x_Mikasa")..')', 1, 'md') 
...
local x_Mikasa = '꙳.︙اهلا عزيزي -› '..AbsRank(msg)..' \n꙳.︙تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, x_Mikasa, 14, string.len(msg.sender_user_id_))
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙عدد اعضاء المجموعه اقل من -› *'..(DevAbs:get(Mikasa..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
local x_Mikasa =  DevAbs:smembers(Mikasa..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..x_Mikasa[math.random(#x_Mikasa)]..']' , 1, 'md')  
end
end
--     Source Mikasa     --
...
function x_Mikasa(extra,result,success)
...
getUser(msg.sender_user_id_, x_Mikasa)
end
end
--     Source Mikasa     --
text = msg.content_.text_
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@x_Mikasa]'))
...
if DevAbs:sismember(Mikasa..'Abs:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n꙳.︙ارسل -› الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n꙳.︙بعد ذلك يرجى ارسال امر -› تفعيل\n꙳.︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevAbs:get(Mikasa.."Abs:Text:BotWelcome") then AbsText = DevAbs:get(Mikasa.."Abs:Text:BotWelcome") else AbsText = "꙳.︙مرحبا انا بوت اسمي "..NameBot.."\n꙳.︙حالة المجموعه -› "..BotText.."\n≪━━━━━ꪑ𝙠━━━━━≫" end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@x_Mikasa]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Mikasa     --
--        Contact         --
...
if DevAbs:get('x_Mikasa:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('x_Mikasa:'..Mikasa..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم الغاء الامر', 1, 'md')
DevAbs:del('x_Mikasa:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('x_Mikasa:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('x_Mikasa:'..Mikasa..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('x_Mikasa:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('x_Mikasa:'..Mikasa..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم الغاء الامر', 1, 'md')
DevAbs:del('x_Mikasa:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('x_Mikasa:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('x_Mikasa:'..Mikasa..'ids:user'..msg.chat_id_)  
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Mikasa..'.json', '꙳.︙يحتوي الملف على -› '..#List..' مجموعه',dl_cb, nil)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/x_Mikasa&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else 
end 
end,nil) 
end
...
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا')
local x_Mikasa = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa[math.random(#x_Mikasa)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا') 
local x_Mikasa = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa[math.random(#x_Mikasa)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا') then 
NameBot = (DevAbs:get(Mikasa..'Abs:NameBot') or 'ميكاسا')
local x_Mikasa = {'كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' '} 
Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa[math.random(#x_Mikasa)] , 1, 'html') 
return false 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'꙳.︙عدد النقاط التي ربحتها -› '..(DevAbs:get(Mikasa..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(Mikasa..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(Mikasa..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم حذف جميع نقاطك', 1, 'md') end
--     Source Mikasa     --
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
x_Mikasa = '꙳.︙اول واحد يدز هذا السمايل يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
...
x_Mikasa = '꙳.︙مبروك لقد ربحت في اللعبه \n꙳.︙ارسل -› سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
...
x_Mikasa = '꙳.︙اول واحد يرتبها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
if text == DevAbs:get(Mikasa..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Mikasa..'Abs:Games:Ids'..msg.chat_id_) then
...
x_Mikasa = '꙳.︙اول واحد يحلها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
if text == DevAbs:get(Mikasa..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Mikasa..'Abs:Games:Ids'..msg.chat_id_) then
...
x_Mikasa = '꙳.︙ما معنى هذا السمايل :؟ -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
x_Mikasa = '꙳.︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
...
x_Mikasa = '꙳.︙اكمل المثال التالي -› ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
...
x_Mikasa = '꙳.︙اكمل المعادله التاليه -› ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md')
return false
end end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'꙳.︙تم بيع '..(DevAbs:get(Mikasa..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n꙳.︙كل نقطه تساوي 50 رساله', 'md')
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),x_Mikasa)
end
end
--     Source Mikasa     --
...
Text = [[
Welcome To Source
𓄇[˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .](https://t.me/x_Mikasa)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˛ ꪑ𝓲𝙠ꪖ𝘴𝙖 𝙩ꫀꪖ𝙢 .',url="https://t.me/x_Mikasa"}},
{{text = '˛ ᦔꫀ𝙫 𝙨ꪊ𝙧𝘴 .',url="t.me/DODDD"},{text = '˛ 𝓽᭙𝘴 bꪮ𝓽 .',url="https://t.me/Yv4bot"}},{{text= '˛ ꪑ𝙮 ᥴ𝙝ꪖꪀ𝙣ꫀꪶ .',url="https://t.me/DoDDDD"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/x_Mikasa&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(Mikasa..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Abs(msg.chat_id_, msg.id_, 1, "꙳.︙عدد تعديلاتك -› *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(Mikasa..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbs:del(Mikasa..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source Mikasa     --
if text == "المطور" then 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/x_Mikasa")}}}
local msg_id = msg.id_/2097152/0.5
...
local x_Mikasa = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md') 
local x_Mikasa = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..x_Mikasa[math.random(#x_Mikasa)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,x_Mikasa)
end
end
--     Source Mikasa     --
...
local x_Mikasa = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md') 
local x_Mikasa = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..x_Mikasa[math.random(#x_Mikasa)], 1, 'md') 
end 
...
local x_Mikasa = "صارر ستاذيي ??🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md') 
local x_Mikasa = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..x_Mikasa[math.random(#x_Mikasa)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local x_Mikasa = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md') 
local x_Mikasa = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..x_Mikasa[math.random(#x_Mikasa)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local x_Mikasa = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,x_Mikasa, 1, 'md') 
local x_Mikasa = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..x_Mikasa[math.random(#x_Mikasa)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
local Text = '꙳.︙قم باستعمال الازرار لرفع العضو -› ⤈\n꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'x_Mikasa')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
end
...
local Text = '꙳.︙قم باستعمال الازرار لتنزيل العضو -› ⤈\n꙳.︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'x_Mikasa')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .',url="t.me/x_Mikasa"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
x_Mikasa = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,x_Mikasa[math.random(#x_Mikasa)])
end
--     Source Mikasa     --
...
--     Source Mikasa     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevAbs:get(Mikasa..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Mikasa     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevAbs:get(Mikasa..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
...
DevAbs:set('x_Mikasa:'..Mikasa..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('x_Mikasa:'..Mikasa.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('x_Mikasa:'..Mikasa..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('x_Mikasa:'..Mikasa.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
if text == 'تحويل' and not DevAbs:get(Mikasa..'Abs:Thwel:Abs'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
sudobot = '\n꙳.︙عدد الكروبات -› '..(DevAbs:get(Mikasa..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n꙳.︙عدد الكروبات -› '..(DevAbs:get(Mikasa..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n꙳.︙عدد الكروبات -› '..(DevAbs:get(Mikasa..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevAbs:sismember(Mikasa..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(Mikasa..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(Mikasa..'Abs:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(Mikasa..'Abs:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(Mikasa..'Abs:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevAbs:sismember(Mikasa..'Abs:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAbs:sismember(Mikasa..'Abs:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAbs:sismember(Mikasa..'Abs:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAbs:sismember(Mikasa..'Abs:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAbs:sismember(Mikasa..'Abs:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙الحظر العام -› '..banall..'\n꙳.︙الكتم العام -› '..muteall..'\n꙳.︙الحظر -› '..banned..'\n꙳.︙الكتم -› '..muted..'\n꙳.︙التقيد -› '..tkeed, 1, 'md')  
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙*المعرف غير صحيح*', 1, 'md')  
end
...
DevAbs:set("Mikasa:New:id:"..Mikasa..msg.sender_user_id_,'x_Mikasa')
return "x_Mikasa"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙رجائا اتبع التعليمات للتعيين \n꙳.︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه -› ⤈\n≪━━━━━ꪑ𝙠━━━━━≫\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n≪━━━━━ꪑ𝙠━━━━━≫', 1, 'md')
DevAbs:set("Mikasa:New:id:"..Mikasa..msg.chat_id_..msg.sender_user_id_,'x_Mikasa')
return "x_Mikasa"
end
...
function x_Mikasa(extra,abbas,success)
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'꙳.︙عدد الكروبات الان -› { '..#group..' }'..Mikasagp1..Mikasagp2..'\n꙳.︙العدد الحقيقي الان  -› ( '..Mikasagp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
if M ~= 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "꙳.︙عدد الميديا -› "..M.."\n꙳.︙الحذف التلقائي -› "..(DevAbs:get(Mikasa..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
--     Source Mikasa     --
if DevAbs:get(Mikasa..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevAbs:get(Mikasa..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAbs:get(Mikasa.."Abs:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevAbs:get(Mikasa..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevAbs:get(Mikasa..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevAbs:get(Mikasa..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevAbs:get(Mikasa..'Abs:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(Mikasa..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAbs:get(Mikasa..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAbs:get(Mikasa..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAbs:get(Mikasa..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAbs:get(Mikasa..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAbs:get(Mikasa..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text == "غنيلي" and not DevAbs:get(Mikasa..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "متحركه" or text == "-› متحركه ᥀") and not DevAbs:get(Mikasa..'Abs:gif:Abs'..msg.chat_id_) and SourceCh(msg) then
Abs = math.random(2,1075); 
local Text ='*᥀︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '᥀ Mikasa Team .',url="t.me/x_Mikasa"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "ميمز" or text == "-› ميمز ᥀") and not DevAbs:get(Mikasa..'Abs:memz:Abs'..msg.chat_id_) and SourceCh(msg) then
...
if text == "الروابط" then if DevAbs:get(Mikasa..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الروابط -› "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(Mikasa..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙المعرف -› "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(Mikasa..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙المتحركه -› "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(Mikasa..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الملصقات -› "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الصور" then if DevAbs:get(Mikasa..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الصور -› "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(Mikasa..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الفيديو -› "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(Mikasa..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙الاونلاين -› "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(Mikasa..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الدردشه -› "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(Mikasa..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙التوجيه -› "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(Mikasa..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الاغاني -› "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(Mikasa..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙الصوت -› "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(Mikasa..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الجهات -› "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(Mikasa..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙الماركداون -› "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(Mikasa..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙الهاشتاك -› "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "التعديل" then if DevAbs:get(Mikasa..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙التعديل -› "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(Mikasa..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙التثبيت -› "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(Mikasa..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الاشعارات -› "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(Mikasa..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الكلايش -› "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الدخول" then if DevAbs:get(Mikasa..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local x_Mikasa = "\n" .."꙳.︙الدخول -› "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(Mikasa..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الشبكات -› "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "المواقع" then if DevAbs:get(Mikasa..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙المواقع -› "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "العربيه" then if DevAbs:get(Mikasa..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙العربيه -› "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(Mikasa..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local x_Mikasa = "\n" .."꙳.︙الانكليزيه -› "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الكفر" then if DevAbs:get(Mikasa..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local x_Mikasa = "\n" .."꙳.︙الكفر -› "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الفشار" then if DevAbs:get(Mikasa..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local x_Mikasa = "\n" .."꙳.︙الفشار -› "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(Mikasa..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local x_Mikasa = "\n" .."꙳.︙الطائفيه -› "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, x_Mikasa, 1, 'md') end
end
--     Source Mikasa     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/x_Mikasa' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "x_Mikasa")..")"
else 
...
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد -› '..#DevAbs:smembers(Mikasa..'Abs:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help0'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help01'..msg.sender_user_id_)
if x_Mikasa == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help21'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help31'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help41'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help51'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local x_Mikasa =  DevAbs:get(Mikasa..'Abs:Help61'..msg.sender_user_id_)
if x_Mikasa == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '꙳.︙Channel ↬ [@x_Mikasa]', 1, 'md')    
end 
--     Source Mikasa     --
