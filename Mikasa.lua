...
⌔︙م6 -› اوامر الاعضاء
━─━─━─ ⌔ ─━─━─━
⌔︙[Source Channel](https://t.me/TeAmMikasa)
]] 
keyboard = {} 
...
Text = [[
Welcome To Source
𓄇[˛ 𝙢𝓲𝙠𝙨𝙖ꪖ .](https://t.me/TeAmMikasa)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = "• *The developer and programmer of this source is* : [MaLaTH Al DleM](https://t.me/DoDDD)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- 𝗆𝖺𝗅𝖺𝗍𝗁 𝖺𝗅 𝖽𝗅𝖾𝗆 .',url="t.me/DoDDD"}}}
local msg_id = msg.id_/2097152/0.5
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TeAmMikasa/MikasaFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/TeAmMikasa/MikasaFiles/master/MikasaFiles/"..FileName)
if Res == 200 then
